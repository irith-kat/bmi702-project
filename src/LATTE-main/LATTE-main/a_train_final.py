...
def parse_arguments(parser):
    ...
    parser.add_argument(
        "--embedding_filename",
        type=str,
        default="embedding_items_HF_PCA80.csv",
        help="Filename of the embedding_filename data",
    )
    parser.add_argument(
        "--key_code",
        type=str,
        default="PheCode:428",  # PheCode:250.2
    ...
    parser.add_argument(
        "--unlabel_filename",
        type=str,
        default="T2D_unlabeled_codified_all_removed3.csv",
    ...
    parser.add_argument(
        "--results_filename",
        type=str,
        default="results_RETTAIN.csv",
        help="Filename to save the result data",
    )
    parser.add_argument(
        "--colums_min", type=int, default=4, help="data beginning column index  "
    )
    parser.add_argument(
        "--colums_max", type=int, default=120, help="data end column index"
    )
    parser.add_argument("--epochs", type=int, default=60, help="training epoches")
    parser.add_argument("--month_window", type=int, default=3, help="month_window")
    parser.add_argument("--max_visits", type=int, default=115, help="max visits length")
    parser.add_argument(
        "--flag_train_augment",
        type=int,
        default=1,
...
if __name__ == "__main__":
    ...
    get_data_from_csv(
        ...
        train_filename,
        train_directory,
        target_patient=target_patient[0],
        colums_min=colums_min,
        colums_max=colums_max,
        visit_maximum=max_visits,
        dic_items=dic_colums,
        month_window=month_window,
        train_mode="train",
        key_code=key_code,
        embedding_file=embedding_filename,
        flag_train_augment=flag_train_augment,
        data_flag=data_flag,
    )
    get_data_from_csv(
        test_directory,
        ...
        test_filename,
        test_directory,
        target_patient=target_patient[1],
        colums_min=colums_min,
        colums_max=colums_max,
        visit_maximum=max_visits,
        dic_items=dic_colums,
    ...
    get_data_from_csv(
        ...
        unlabel_filename,
        unlabel_directory,
        target_patient=target_patient[2],
        colums_min=colums_min,
        colums_max=colums_max,
        visit_maximum=max_visits,
        dic_items=dic_colums,
    ...
    Attention_train(
        ...
        weights_prevalence=ARGS.weight_prevalence,
        weights_unlabel=ARGS.weight_unlabel,
        weights_constrastive=ARGS.weight_constrastive,
        weight_smooth=ARGS.weight_smooth,
        weights_additional=ARGS.weight_additional,
