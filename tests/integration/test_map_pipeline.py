...
Note: prepare_map_inputs uses pivot_table(aggfunc="count") with no values=,
producing MultiIndex columns. We flatten before calling run_map.
"""
...
_DIAGNOSES = [
    # RA patients
    (10001,1001,1,"M059",10),(10001,1001,2,"I10",10),
    (10001,1002,1,"M059",10),(10001,1003,1,"M059",10),
    (10001,1004,1,"M059",10),(10001,1004,2,"M060",10),
    (10001,1005,1,"M059",10),(10001,1006,1,"M059",10),
    (10001,1007,1,"M059",10),(10001,1007,2,"I10",10),
    (10001,1008,1,"M059",10),(10001,1009,1,"M059",10),
    (10001,1010,1,"M059",10),(10001,1010,2,"M060",10),
    (10002,1011,1,"M059",10),(10002,1011,2,"M060",10),
    (10002,1012,1,"M059",10),(10002,1013,1,"M059",10),
    (10002,1014,1,"M059",10),(10002,1014,2,"E119",10),
    (10002,1015,1,"M059",10),(10002,1016,1,"M059",10),
    (10002,1017,1,"M059",10),(10002,1018,1,"M059",10),
    (10002,1019,1,"M059",10),(10002,1019,2,"M060",10),
    (10003,1020,1,"M059",10),(10003,1021,1,"M059",10),
    (10003,1022,1,"M059",10),(10003,1022,2,"I10",10),
    (10003,1023,1,"M059",10),(10003,1024,1,"M059",10),
    (10003,1025,1,"M059",10),(10003,1026,1,"M059",10),
    (10003,1027,1,"M059",10),
    (10004,1030,1,"M059",10),(10004,1031,1,"M059",10),
    (10004,1032,1,"M059",10),(10004,1032,2,"E119",10),
    (10004,1033,1,"M059",10),(10004,1034,1,"M059",10),
    (10004,1035,1,"M059",10),(10004,1035,2,"M060",10),
    (10004,1036,1,"M059",10),(10004,1037,1,"M059",10),
    (10005,1040,1,"M059",10),(10005,1040,2,"M060",10),
    (10005,1041,1,"M059",10),(10005,1042,1,"M059",10),
    (10005,1043,1,"M059",10),(10005,1044,1,"M059",10),
    (10005,1045,1,"M059",10),(10005,1045,2,"I10",10),
    (10005,1046,1,"M059",10),(10005,1047,1,"M059",10),
    (10005,1048,1,"M059",10),(10005,1049,1,"M059",10),
    (10006,1050,1,"M059",10),(10006,1051,1,"M059",10),
    (10006,1052,1,"M059",10),(10006,1052,2,"E119",10),
    (10006,1053,1,"M059",10),(10006,1054,1,"M059",10),
    (10006,1055,1,"M059",10),(10006,1056,1,"M059",10),
    # Non-RA patients (20003 has one stray M059 — miscoding)
    (20001,2001,1,"I10",10),(20001,2001,2,"E119",10),(20001,2002,1,"I10",10),
    (20002,2003,1,"I10",10),(20002,2004,1,"I10",10),
    (20003,2005,1,"M059",10),(20003,2005,2,"I10",10),
    (20004,2006,1,"E119",10),(20004,2007,1,"I10",10),
    (20005,2008,1,"I10",10),(20005,2009,1,"E119",10),
    (20006,2010,1,"E119",10),(20006,2010,2,"I10",10),
]
...
def phecode_mapping(tmp_path_factory):
    ...
    pd.DataFrame({
        ...
        "PhecodeString": ["Rheumatoid arthritis", "Rheumatoid arthritis",
...
def ehr_df():
    return pd.DataFrame(
        _DIAGNOSES, columns=["subject_id", "hadm_id", "seq_num", "icd_code", "icd_version"]
    )
...
def pipeline_outputs(ehr_df, notes_df, phecode_mapping):
    ...
    with patch.object(
        preprocessing, "rollup_icd_to_phecode",
        side_effect=lambda df, col: rollup_icd_to_phecode(df, col, phecode_mapping),
    ):
        mat_df, note_df = preprocessing.prepare_map_inputs(ehr_df, notes_df, icd_col="icd_code")

    # flatten MultiIndex produced by pivot_table(aggfunc="count", values=None)
    if isinstance(mat_df.columns, pd.MultiIndex):
        mat_df = mat_df.xs(mat_df.columns.get_level_values(0)[0], level=0, axis=1)
